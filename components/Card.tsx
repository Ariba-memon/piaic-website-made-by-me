...
<h2 className="text-4xl font-extrabold text-green-400 text-center m-4 p-4 md:text-2xl">
          Grand Entry Test
            </h2>
      ...
      <div className="flex w-1/3 flex-wrap">
        <div className="w-full p-1 md:p-2">
          <img
            alt="gallery"
            className="block h-full w-full rounded-lg object-cover object-center shadow-none transition-shadow duration-300 ease-in-out hover:shadow-lg hover:shadow-black/30"
            src="https://propakistani.pk/wp-content/uploads/2022/02/entrance-test.jpg" />
        </div>
      </div>
      <div className="flex w-1/3 flex-wrap">
        <div className="w-full p-1 md:p-2">
