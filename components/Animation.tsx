...
export default function App() {
  return (
    <div  className="md:max-xl:flex"><> <Text  className='text-justify bg-gradient-to-r from-green-900'fontStyle='revert' fontSize='20'  backgroundColor="green.400" fontFamily="Roboto" color='white' alignItems="center" padding='10' margin="0 auto" >Admissions are now open in Web 3.0 & Metaverse Program in Karachi , Lahore , Islamabad For Queries contact PIAIC helpline <b>03082220203</b> 
   </Text>
   <br />
  <br />
  <Card />
