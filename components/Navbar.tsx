    ...
    <Stack minH={'100vh'} direction={{ base: 'column', md: 'row' }}>
      <Flex p={8} flex={1} align={'center'} justify={'center'}>
        <Stack spacing={6} w={'full'} maxW={'md'}>
          ...
          <Text className='text-justify bg-gradient-to-r from-green-100'fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
      ...
      <Flex flex={1}>
       ...
       className='animate-pulse'
          src={
            'https://alvidental.com/wp-content/uploads/2017/02/000.png'
          }
        />
      </Flex>
    </Stack>
